...
import { z } from "zod";
import { verifyResource, updateResource, createResource, deleteResource, moveResource } from "@/lib/queries";

const schema = z.object({
  id: z.number().optional(),
  action: z.enum(["verify", "update", "create", "delete", "move"]),
...
export async function POST(req: Request) {
  ...
  const { id, action, url, fields, dir } = parsed.data;
